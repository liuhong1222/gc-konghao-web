        ...
        function validateRule(oRegex, sVal, sName, sIdContainer) {
            ...
            if (oRegex.test(sVal)) {
                if ($(".rules .ok").length == 4) {
                    $("#gs").hide()
                    $("#loginTwoPwd").removeAttr('disabled')
                    $(".trueupdatePwdField").removeAttr('disabled')
                    $(".emailEditNewPwdNext").removeAttr('disabled')


                } else {
                    // $("#checkRulesList").hide();
                    // $("#gs").show();
                    $("#loginTwoPwd").attr('disabled', 'disabled')
                    $("#loginTwoPwd").val('')
                    $(".trueupdatePwdField").attr('disabled', 'disabled')
                    $(".trueupdatePwdField").val('')
                    $(".emailEditNewPwdNext").attr('disabled', 'disabled')
                    $(".emailEditNewPwdNext").val('')
                }
